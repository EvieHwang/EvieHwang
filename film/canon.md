...
- **Sci-fi and space as a resonant register.** Hard sci-fi and space films form a distinct cluster where the genre's formal properties align with core taste axes: cosmic scale (the individual against an indifferent universe), philosophical ambition, survival and competence under impossible conditions, visual grandeur that earns awe. Films that hit: *Gravity* (A), *The Martian* (A), *Arrival* (A); strong unranked candidates: *Interstellar*, *Prometheus*. Genre love is genuine and should be actively exploited in future slates — particularly films that layer sci-fi ambition over the model's established axes (clear-eyed protagonist, style as argument, moral architecture). Corollary: a single dramatically loaded image does more argumentative work than sustained atmosphere — the Engineer dissolving at the dawn of life vs. the heptapods that never earn an image of equivalent weight.
...
4. **Untested forms.** Pre-1960: ANSWERED (*Paths of Glory*, A). Comedy-as-craft: ANSWERED (B ceiling). Spectacle-as-primary: ANSWERED (*Fury Road*, B). Animation and documentary still near-zero data.
...
**Sci-fi and space (confirmed register — promote into next slate)**
- Interstellar (2014, Nolan) — philosophical ambition explicit; scale and loss as the argument. Test: does Nolan's formal control produce load-bearing argument or expensive spectacle?
- Prometheus (2012, Scott) — unranked; the opening is mythic. Test: does the film hold beyond the Engineer sequence, or is it one great image in search of a movie?
