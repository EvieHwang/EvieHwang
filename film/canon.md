...
5. **Anti-triumphalist / triumphalist hypothesis: partially tested.** *Fury Road* (B): tainted triumph structurally present but spectacle mode prevented landing. *Arrival* is the cleaner test.
...
**② Arrival (2016, Villeneuve) — EXPLORE**
*Tests the triumphalist hypothesis in the quiet philosophical mode.* Louise prevents a war — genuine triumph — but has chosen to live with the knowledge of her daughter's death from the beginning. No spectacle to pull focus; the argument arrives through language, memory, grief. **High tier →** tainted triumph in a quiet register scores high; the anti-triumphalist pattern is about the world remaining itself, not failure specifically. **Low →** the non-linear structure or sci-fi frame creates the wrong kind of distance.
